...
describe('lib/index', () => {
  ...
  describe('static clearLeaseManagerCache', () => {
    test('calls LeaseManager.clearInstancesLeaseData(', () => {
      LeaseManager.clearInstancesLeaseData = jest.fn();
      Kinesis.clearLeaseManagerCache('mock-consumer-group');
      expect(LeaseManager.clearInstancesLeaseData).toHaveBeenCalledWith('mock-consumer-group');
    });
  });
});
