...
describe('lib/index', () => {
  ...
  test('connect should instantiate an AWS SDK Kinesis object', async () => {
    const kinesis = new Kinesis({ consumerName, foo: 'bar', streamName });
  ...
  test('connect should use the provided logger', async () => {
    ...
    await new Kinesis({ consumerName, logger, streamName }).connect();
  ...
  test('connect should encrypt a stream if provided with the encryption options', async () => {
    await new Kinesis({ consumerName, encryption: { foo: 'bar' }, streamName }).connect();
