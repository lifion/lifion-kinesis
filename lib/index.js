...
class Kinesis extends PassThrough {
   ...
   * @param {boolean} [options.useCachedAPIResponses=false] - Set to `false` to not reuse AWS API calls responses
  ...
  constructor(options = {}) {
    ...
    Object.assign(internal(this), {
      ...
      useCachedAPIResponses: Boolean(useCachedAPIResponses),
  ...
  static clearLeaseManagerCache(consumerGroup) {
    LeaseManager.clearInstancesLeaseData(consumerGroup);
  }
}
